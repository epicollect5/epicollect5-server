...
return [
    ...
    "ec5_78" => "This project is private. <br/> You need permission to access it.",
    ...
    "ec5_390" => "Local account with the provided email already exists. <br/> Please enter the password to confirm",
    "ec5_391" => "Local account with the provided email already exists. <br/> Please login via email",
