...
return [
    ...
    "ec5_31" => "Google user could not be authenticated. Please contact support.",
    ...
    "ec5_36" => "User password or email incorrect.",
    ...
    "ec5_71" => "You need permission to view this project.",
    ...
    "ec5_116" => "Server error, please try again later. If the problem persists, please contact support.",
    ...
    "ec5_202" => "This project is locked.",
    ...
    "ec5_213" => "Invalid state exception. Cookie domain or storage permissions not set. Please contact support.",
    ...
    "ec5_220" => "No < or > chars allowed.",
    "ec5_221" => "This Project is Featured and cannot be deleted. Please contact support.",
    "ec5_222" => "Project could not be deleted. Please contact support.",
    "ec5_223" => "Could not delete project media. Please contact support.",
    ...
    "ec5_266" => "Auth user exception. Please contact support.",
    "ec5_267" => "User could not be authenticated via the app. Please contact support.",
    ...
    "ec5_367" => "Local account found. Please enter your password",
    ...
    "ec5_383" => "Account with the provided email already exists.\n Login with email to connect your Google Account",
    "ec5_384" => "Account with the provided email already exists.\n Login with email to connect your Apple Account",
    ...
    "ec5_390" => "Local account with the provided email already exists. \n Please enter the password to confirm",
    "ec5_391" => "Local account with the provided email already exists. \n Please login via email",
    "ec5_392" => "The regular expression is invalid or malformed.",
    "ec5_393" => "Project description must be between :min to :max chars long",
