...
class ProjectMappingDTO extends ProjectModelBase
{
     ...
     */
    public function autoGenerateMap(ProjectExtraDTO $projectExtra)
    {
        $mapIndex = 0;
        ...
        $this->data[$mapIndex] = [
            ...
            'is_default' => $this->data[$mapIndex]['is_default'] ?? true,
            'map_index' => $mapIndex
        ];
    }
     ...
     * @return array
     */
    public function getAutoGeneratedMap(ProjectExtraDTO $projectExtra): array
    {
     ...
     * @return array
     */
    private function mapInputs(ProjectExtraDTO $projectExtra, $formRef, array $inputs): array
    {
        $map = [];
     ...
     * @return array
     */
    private function mapInput(ProjectExtraDTO $projectExtra, $formRef, $inputData): array
    {
    ...
    public function createCustomMap($params)
    {
     ...
     * @param ProjectExtraDTO $projectExtra
     */
    public function syncNewStructure(ProjectExtraDTO $projectExtra)
    {
