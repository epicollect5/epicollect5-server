...
class EntryCounter extends Model
{
     ...
     * @param EntryStructureDTO $entryStructure
     */
    public function updateEntryCounts(ProjectDTO $project, EntryStructureDTO $entryStructure)
    {
     ...
     * @param EntryStructureDTO $entryStructure
     */
    public function updateParentEntryCounts(EntryStructureDTO $entryStructure)
    {
