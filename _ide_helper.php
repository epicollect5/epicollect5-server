...
namespace Illuminate\Support\Facades {
     ...
     */        class Auth {
         ...
         *
         * @return \ec5\Models\User\User|null 
         * @static 
         ...
         *
         * @param mixed $id
         * @return \ec5\Models\User\User|false 
         * @static 
     ...
     */        class Response {
         ...
         * 
         *
         * @see \ec5\Providers\ApiResponseProvider::boot()
         * @param mixed $content
         * @static 
         */        public static function apiResponse($content)
        {
                        return \Illuminate\Routing\ResponseFactory::apiResponse($content);
        }
                    /**
         * 
         *
         * @see \ec5\Providers\Macros\Response\ApiErrorCodeMacro::boot()
         * @param mixed $httpStatusCode
         * @param array $errors
         * @param array $extra
         * @static 
         */        public static function apiErrorCode($httpStatusCode, $errors, $extra = [])
        {
                        return \Illuminate\Routing\ResponseFactory::apiErrorCode($httpStatusCode, $errors, $extra);
        }
                    /**
         * 
         *
         * @see \ec5\Providers\Macros\Response\ApiSuccessCodeMacro::boot()
         * @param mixed $code
         * @static 
         */        public static function apiSuccessCode($code)
        {
                        return \Illuminate\Routing\ResponseFactory::apiSuccessCode($code);
        }
                    /**
         * 
         *
         * @see \ec5\Providers\Macros\Response\ApiDataMacro::boot()
         * @param mixed $data
         * @param mixed $meta
         * @param mixed $links
         * @static 
         */        public static function apiData($data, $meta = null, $links = null)
        {
                        return \Illuminate\Routing\ResponseFactory::apiData($data, $meta, $links);
        }
                    /**
         * 
         *
         * @see \ec5\Providers\Macros\Response\ToCSVStreamMacro::boot()
         * @param mixed $data
         * @static 
         */        public static function toCSVStream($data)
        {
                        return \Illuminate\Routing\ResponseFactory::toCSVStream($data);
        }
                    /**
         * 
         *
         * @see \ec5\Providers\Macros\Response\ToCSVFileMacro::boot()
         * @param mixed $content
         * @param mixed $filename
         * @static 
         */        public static function toCSVFile($content, $filename)
        {
                        return \Illuminate\Routing\ResponseFactory::toCSVFile($content, $filename);
        }
                    /**
         * 
         *
         * @see \ec5\Providers\Macros\Response\ToJSONFileMacro::boot()
         * @param mixed $content
         * @param mixed $filename
         * @static 
         */        public static function toJSONFile($content, $filename)
        {
                        return \Illuminate\Routing\ResponseFactory::toJSONFile($content, $filename);
        }
                    /**
         * 
         *
         * @see \ec5\Providers\Macros\Response\ToMediaStreamMacro::boot()
         * @param \Illuminate\Http\Request $request
         * @param mixed $realFilepath
         * @param mixed $inputType
         * @static 
         */        public static function toMediaStream($request, $realFilepath, $inputType)
        {
                        return \Illuminate\Routing\ResponseFactory::toMediaStream($request, $realFilepath, $inputType);
        }
            }
            /**
     * 
...
namespace ec5\Libraries\Ldap {
     ...
     */        class Ldap {
         ...
         *
         * @param array $credentials
         * @return \ec5\Libraries\Ldap\LdapUser 
         * @static 
         */        public static function retrieveByCredentials($credentials)
        {
                        /** @var \ec5\Libraries\Ldap\LdapUserProvider $instance */
                        return $instance->retrieveByCredentials($credentials);
        }
                    /**
