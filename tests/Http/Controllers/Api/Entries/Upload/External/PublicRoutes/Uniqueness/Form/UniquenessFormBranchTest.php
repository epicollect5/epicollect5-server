...
class UniquenessFormBranchTest extends TestCase
{
    ...
    public function test_form_uniqueness_branch_text_by_web_upload()
    {
        //get branch inputs
    ...
    public function test_form_uniqueness_branch_integer_by_web_upload()
    {
        //get branch inputs
        $inputs = array_get($this->projectDefinition, 'data.project.forms.0.inputs');
        //get the first text question of the first branch and add form uniqueness
    ...
    public function test_form_uniqueness_branch_decimal_by_web_upload()
    {
        //get branch inputs
        $inputs = array_get($this->projectDefinition, 'data.project.forms.0.inputs');
        //get the first text question of the first branch and add form uniqueness
    ...
    public function test_form_uniqueness_branch_phone_by_web_upload()
    {
        //get branch inputs
        $inputs = array_get($this->projectDefinition, 'data.project.forms.0.inputs');
        //get the first text question of the first branch and add form uniqueness
    ...
    public function test_form_uniqueness_branch_date_by_web_upload_format_0()
    {
        //get branch inputs
        $inputs = array_get($this->projectDefinition, 'data.project.forms.0.inputs');
        //get the first text question of the first branch and add form uniqueness
            ...
            if ($input['type'] === config('epicollect.strings.inputs_type.branch')) {
                ...
                foreach ($branchInputs as $branchInputIndex => $branchInput) {
                    if ($branchInput['type'] === config('epicollect.strings.inputs_type.date')) {
                        $this->projectDefinition['data']['project']['forms'][0]['inputs'][$index]['branch'][$branchInputIndex]['uniqueness'] = 'form';
                        $this->projectDefinition['data']['project']['forms'][0]['inputs'][$index]['branch'][$branchInputIndex]['datetime_format']
                            = $format;
                        $branchInputRef = $branchInput['ref'];
                        break 2;
                    }
    ...
    public function test_form_uniqueness_branch_date_by_web_upload_format_1()
    {
        //get branch inputs
        $inputs = array_get($this->projectDefinition, 'data.project.forms.0.inputs');
        //get the first text question of the first branch and add form uniqueness
    ...
    public function test_form_uniqueness_branch_date_by_web_upload_format_2()
    {
        //get branch inputs
        $inputs = array_get($this->projectDefinition, 'data.project.forms.0.inputs');
        //get the first text question of the first branch and add form uniqueness
    ...
    public function test_form_uniqueness_branch_date_by_web_upload_format_3()
    {
        //get branch inputs
        $inputs = array_get($this->projectDefinition, 'data.project.forms.0.inputs');
        //get the first text question of the first branch and add form uniqueness
    ...
    public function test_form_uniqueness_branch_date_by_web_upload_format_4()
    {
        //get branch inputs
        $inputs = array_get($this->projectDefinition, 'data.project.forms.0.inputs');
        //get the first text question of the first branch and add form uniqueness
    ...
    public function test_form_uniqueness_branch_time_by_web_upload_format_0()
    {
        //get branch inputs
        $inputs = array_get($this->projectDefinition, 'data.project.forms.0.inputs');
        //get the first text question of the first branch and add form uniqueness
    ...
    public function test_form_uniqueness_branch_time_by_web_upload_format_1()
    {
        //get branch inputs
        $inputs = array_get($this->projectDefinition, 'data.project.forms.0.inputs');
        //get the first text question of the first branch and add form uniqueness
    ...
    public function test_form_uniqueness_branch_time_by_web_upload_format_2()
    {
        //get branch inputs
        $inputs = array_get($this->projectDefinition, 'data.project.forms.0.inputs');
        //get the first text question of the first branch and add form uniqueness
    ...
    public function test_form_uniqueness_branch_time_by_web_upload_format_3()
    {
        //get branch inputs
        $inputs = array_get($this->projectDefinition, 'data.project.forms.0.inputs');
        //get the first text question of the first branch and add form uniqueness
    ...
    public function test_form_uniqueness_branch_time_by_web_upload_format_4()
    {
        //get branch inputs
        $inputs = array_get($this->projectDefinition, 'data.project.forms.0.inputs');
        //get the first text question of the first branch and add form uniqueness
    ...
    public function test_form_uniqueness_branch_textbox_by_web_upload()
    {
        //get branch inputs
        $inputs = array_get($this->projectDefinition, 'data.project.forms.0.inputs');
        //get the first text question of the first branch and add form uniqueness
    ...
    public function test_form_uniqueness_branch_barcode_by_web_upload()
    {
        //get branch inputs
        $inputs = array_get($this->projectDefinition, 'data.project.forms.0.inputs');
        //get the first text question of the first branch and add form uniqueness
