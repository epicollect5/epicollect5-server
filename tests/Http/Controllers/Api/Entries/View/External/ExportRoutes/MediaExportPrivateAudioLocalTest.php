...
class MediaExportPrivateAudioLocalTest extends TestCase
{
    use Assertions;
    ...
    #[Depends('test_getting_OAuth2_token')] public function test_audios_export_endpoint_private($params)
    {
        ...
        for ($i = 0; $i < 1; $i++) {
            ...
            $audioAnswers[] = $entryPayloads[ $i]['data']['entry']['answers'][$audioRefs[0]];
        ...
        //assert file exists
        $this->assertTrue(Storage::disk('audio')->exists($project->ref . '/' . $filename));
