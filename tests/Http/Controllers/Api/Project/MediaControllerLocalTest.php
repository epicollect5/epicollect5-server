...
class MediaControllerLocalTest extends TestCase
{
    ...
    #[DataProvider('multipleRunProvider')] public function test_project_mobile_logo_is_returned()
    {
        ...
        $this->assertEquals($image->width(), config('epicollect.media.project_mobile_logo')[0]);
        $this->assertEquals($image->height(), config('epicollect.media.project_mobile_logo')[1]);
    ...
    #[DataProvider('multipleRunProvider')] public function test_photo_file_is_returned_as_thumb()
    {
        //create a fake entry
        $entry = factory(Entry::class)->create([
            'project_id' => $this->project->id,
        ...
        $filename = $entry->uuid . '_' . time() . '.jpg';
        Storage::disk('photo')->put($this->project->ref . '/' . $filename, $thumbData);
    ...
    public function test_photo_file_is_returned_landscape_temp()
    {
        ...
        //assert file exists
        $this->assertTrue(Storage::disk('temp')->exists('photo/' . $this->project->ref . '/' . $filename));
