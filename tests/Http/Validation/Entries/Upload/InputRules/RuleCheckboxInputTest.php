...
class RuleCheckboxInputTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->validator = new RuleCheckboxInput();
    ...
    public function test_is_checkbox_valid()
    {
    ...
    public function test_is_checkbox_invalid()
    {
