...
class CategoriesTest extends RuleProjectDefinitionBaseTest
{
     ...
     * @throws Exception
     */
    public function test_it_should_catch_category_empty_string()
    {
        $project = new ProjectDTO(
            $this->projectDefinition,
            $this->projectExtra,
     ...
     * @throws Exception
     */
    public function test_it_should_catch_missing_category_key()
    {
        $project = new ProjectDTO(
            $this->projectDefinition,
            $this->projectExtra,
