...
class UserTest extends TestCase
{
    ...
    {
        $admin = factory(User::class)->create(['server_role' => config('ec5Strings.server_roles.admin')]);
    ...
    {
        $superadmin = factory(User::class)->create(['server_role' => config('ec5Strings.server_roles.superadmin')]);
    ...
    {
        $active = factory(User::class)->create(['state' => config('ec5Strings.user_state.active')]);
    ...
    {
        $unverified = factory(User::class)->create(['state' => config('ec5Strings.user_state.unverified')]);
