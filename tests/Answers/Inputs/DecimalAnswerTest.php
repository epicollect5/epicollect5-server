...
class DecimalAnswerTest extends TestCase
{
     ...
     *
     */
    public function testIsNotDecimal()
    {
        // Invalid answer
        $answer = "£";
        $this->validator->setRules($this->inputDetails, $answer, $this->project);
     ...
     *
     */
    public function testMinMaxAnswerValid()
    {
        // Valid answer
        $answer = 100.01;
        // Sex min/max
     ...
     *
     */
    public function testMinMaxAnswerTooLow()
    {
     ...
     *
     */
    public function testMinMaxAnswerTooHigh()
    {
        // Answer too high
        $answer = 210.88;
        // Sex min/max
