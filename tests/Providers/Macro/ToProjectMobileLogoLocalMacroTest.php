...
class ToProjectMobileLogoLocalMacroTest extends TestCase
{
    ...
    public function test_returns_project_mobile_logo_webp_as_jpeg_from_local_when_available()
    {
    ...
    public function test_returns_project_mobile_logo_legacy_jpeg_from_local_when_available()
    {
        $projectRef = Generators::projectRef();
        $filename = config('epicollect.media.project_avatar.filename');
