        ...
        <section class="main col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 ">
            ...
            <ul class="main__tabs nav nav-tabs" role="tablist">
                ...
                <li role="presentation">
                    ...
                    <a class="main__tabs_add-form" href="#" aria-controls="profile" role="tab" data-toggle="modal"
                       data-target=".main__modal--edit-form-name">Add child form
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Each entry you will add on your device will appear on a list.<br />
                        To identify each entry, you can set some of your question answers to be part of the entry title (up to a maximum of 3 for either a form or a branch)</p>
                    ...
                    <p>Remember, if you do not set any title at all, the entry unique identifier generated by the sistem will be shown instead: <br />
                        <code>149da8d4-2807-11e6-b67b-9e71128cae77</code> <br />
                        Since it is not really readable, we highly recommend you select some questions as <strong>title</strong>!</p>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p> You are probably familiar with wildcard notations such
                        as <code>*.txt</code> to find all text files in a file manager. The regex equivalent is <code>.*\.txt</code></p>
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            <th>
                                Limit the answer length to 20 chars <br />(or any length you like, just replace 20 with the length you want)
                            </th>
                            <td>
                                <button class="btn btn-default btn-action-inverse pull-right"
                    ...
                    <p class="bg-warning"><strong>Important: </strong>make sure the regex fits the context of the input type, as if you apply a letter only regex to a numeric input (which accepts only digits), it would be impossible for the user to answer!</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-action" data-dismiss="modal">Close</button>
                </div>
    ...
    <div id="info-import-form" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Each Epicollect5 form you create using the formbuilder can be exported as a <code>.json</code> file and imported within the same project or another project.</p>

                    <p class="text-center text-underline">
                        <strong>
                            <a href="https://docs.epicollect.net/formbuilder/importexport-forms"
                               target="_blank">Show me how to do it!</a>
                        </strong>
                    </p>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group possible_answers__append-or-replace">
                            <div class="radio">
                                <label>
                                    <input type="radio" name="possibleAnswersImportOptions" id="replace" value="option2"
                                           checked>
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="possibleAnswersImportOptions" id="append" value="option1">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default btn-action possible_answers-perform-import" disabled>Import</button>
                </div>
            </div>
        </div>
    </div>
