...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/vendor-site.css').'?'.Config::get('app.release') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/site.css').'?'.Config::get('app.release') }}">

    {{-- dataviewer css --}}
    <link rel="stylesheet"
          type="text/css"
          href="{{ asset('dataviewer/css/vendor-dataviewer.css').'?'.Config::get('app.release') }}">
    <link rel="stylesheet"
          type="text/css"
          href="{{ asset('dataviewer/css/dataviewer.css').'?'.Config::get('app.release') }}">
    ...
    <script src="{{asset('dataviewer/js/leaflet.markercluster.min.js').'?'.Config::get('app.release')}}" defer></script>
...
<body>
<div id="app"></div>
<script src="{{asset('dataviewer/js/dataviewer.js').'?'.Config::get('app.release')}}"></script>
</body>
</html>
