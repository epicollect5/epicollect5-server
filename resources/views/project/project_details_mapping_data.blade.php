    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Data mapping is an exclusive Epicollect5 feature where you can assign a <strong>short
                        identifier</strong> to each question or to each possible answer.</p>
                <p>This is particularly useful when you want to download your data in CSV format and you need the column
                    name to match an existing identifier, or some possible answer to be mapped against a number or a
                    code.</p>
                <p>For example, a question like <em>"What is your name"</em> can be mapped against just <em>"name".</em>
                </p>
                <p>For possible answers, if the options are like "Red", "Blue" and "Green", they could be mappend
                    against "R", "B", "G".</p>
