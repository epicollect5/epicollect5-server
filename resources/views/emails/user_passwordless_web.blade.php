...
<body style="margin: 20px 0; padding: 0;" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td align="center"
                style="padding: 10px 0px 20px 0px; font-size: 22px; font-family: Arimo, Arial, sans-serif; color: #673C90;">
                <strong>Epicollect5</strong>
            </td>
        </tr>
    </table>
    <table width="100%" border="0" cellspacing="20" cellpadding="0"
        style="max-width: 600px; margin: 20px auto; background-color:#fff">
        <tr>
            <td align="center"
                style="padding: 20px 0px 0px 0px; font-size: 18px; font-family: Arimo, Arial, sans-serif; color: #333;">
                Click the button below to login in as <br /> <strong>{{ $email }}</strong>
            </td>
        </tr>
        <tr>
                    ...
                    <tr>
                        <td align="center" style="border-radius: 5px;">
                            <a href="{{ $url }}" target="_blank"
                                style="background-color:#87C7A6;font-size: 18px; font-family: Arimo, Arial, sans-serif; color: #333; text-decoration: none; border-radius: 5px; padding: 10px 20px; display: inline-block; font-weight: bold;">
                                Login</a>
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td align="center"
                ...
                The link will expire in {{ $expireAt }}.
            </td>
        </tr>
        <tr>
            <td align="center"
                style="padding: 20px 0px 30px 0px; font-size: 16px; line-height: 22px; font-family: Arimo, Arial, sans-serif; color: #333;">
