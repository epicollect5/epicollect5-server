                        ...
                        <div class="btn-login-wrapper">
                            @if (in_array('google', $authMethods))
                                <a href="{{url('redirect/google')}}" class="btn-login-google">
                                    <img class="img-responsive"
                                         src="{{ asset('/images/login-google@2x.png') }}"
                            ...
                            @if (in_array('apple', $authMethods))
                                <a  href="#" class="btn-login-apple">
                                    <img class="img-responsive"
                                         src="{{ asset('/images/login-apple@2x.png') }}"
                        ...
                        @if (in_array('passwordless', $authMethods))
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                                    ...
                                    <form id="page-login__passwordless"
                                          method="POST" action="{{ route('passwordless-token-web') }}" accept-charset="UTF-8">
                                        ...
                                        <div class="form-group">
                                            <input id="passwordless" class="btn btn-default btn-action pull-right" type="submit"
                                                   value="{{trans('site.send')}}">
                                        </div>
                                    </form>
                                </div>
                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form method="POST" action="{{ url('login/ldap') }}" accept-charset="UTF-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" required="required"
                                                       placeholder="{{trans('site.ldap_username')}}"
                                                       name="username" type="text">
                                            </div>
                                            <div class="form-group">
                                                <label for="password">{{trans('site.ldap_password')}}</label>
                                                <input class="form-control" required="required"
                                                       placeholder="{{trans('site.ldap_password')}}"
